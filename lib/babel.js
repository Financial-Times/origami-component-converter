...
export function createConfiguration ({aliases}) {
	return {
		...
		overrides: [
			{
				presets: [
					[getModulePath("@babel/preset-env"), {useBuiltIns: false}]
				],
				plugins: [
					...
					//
					// getModulePath("babel-plugin-transform-es3-member-expression-literals"),
					// getModulePath("babel-plugin-transform-es3-property-literals"),
					[
...
let transform = (code, config) =>
	new Promise((resolve, reject) => {
		babel.transform(code, config, (error, result) => {
